...
Run on channel : 4 (SN 5435)
User : 
CE vs. WE compliance from -10 V to 10 V
Electrode connection : standard
Ewe ctrl range : min = 0,00 V, max = 5,00 V
Acquisition started on : 01.23.2015 15:04:13
Saved on :
	File : LiCoO2 vs Li 300µm GCPL_02_GCPL_C04.mpr
	Directory : C:\Hupfer\Studenten Batterietests\LiCoO2 vs Li 300µm GCPL\
	Host : 192.168.0.2
Device : VMP3 (SN 0324)
Address : 192.168.0.1
