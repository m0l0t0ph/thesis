...
Run on channel : 5 (SN 5436)
User : 
CE vs. WE compliance from -10 V to 10 V
Electrode connection : standard
Ewe ctrl range : min = 0,00 V, max = 5,00 V
Acquisition started on : 01.23.2015 15:07:20
Saved on :
	File : S vs Li GCPL 200µm_02_GCPL_C05.mpr
	Directory : C:\Hupfer\Studenten Batterietests\S vs Li GCPL 200µm\
	Host : 192.168.0.2
Device : VMP3 (SN 0324)
Address : 192.168.0.1
