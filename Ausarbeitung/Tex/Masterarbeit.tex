...
\usepackage[per-mode=symbol]{siunitx} % Einheiten korrekt anzeigen
\usepackage{amssymb} % Eigentlich nur für schönere Häkchen
%\sisetup{
% locale = DE ,
% per-mode = symbol,
...
% Verhindern, dass figures zu schnell auf eigene Seite gestellt werden
...
\end{equation}
So gilt für eine \ce{LiCoO2}-Zelle mit graphitischer Anode ein mittleres Elektrodenpotential der Kathode gegen Lithium von \SI{3.9}{\volt}, der Anode von ungefähr \SI{0.1}{\volt} \cite{bub_skript}. Die Zelle erreicht daher eine theoretische Zellspannung von \SI{3.8}{\volt}.
...
\item[Graphit (\ce{C6})] Graphit besitzt eine Lagenstruktur zwischen der er Lithium einspeichern kann. Es kann jeweils ein Lithiumatom pro sechs Kohlenstoffatomen eingelagert werden. Er erreicht damit eine theoretische Kapazität von \SI{372}{\milli\ampere\hour\per\gram} \cite{delasCasas201274}. Das Potential gegen rein metallisches Lithium ist sehr klein (ca. \SI{0.1}{\volt}), was hohe Zellspannungen ermöglicht. Die Einlagerung erfolgt über drei unterschiedliche Stufen und führt zu einer Volumenzunahme von maximal \SI{9}{\percent} \cite{bub_skript}.
...
\begin{figure}
	...
	\caption{Übersicht über die verschiedenen Teile der in-situ-Testzelle} %(von links): Stempel unten und oben mit Dichtungsring, Mutter, Feder, zusammengebaute Zelle frontal, Glaszelle, Deckel, Positionsplättchen}
...
% Hinweis auf Paul?
\subsection{Herstellung des \ce{LiTiOPO4}-Pulvers}
\label{praep_LiTiOPO4}
\begin{figure}
	\centering
	\includegraphics[width=1.0\columnwidth]{images/SolGel.jpg}
	\caption{Herstellung von \ce{LiTiOPO4} über einen Sol-Gel-Prozess}
	\label{sol_gel}
\end{figure}
Das \ce{LiTiOPO4} ist eine im LATP häufig vorkommende Zweitphase und wird zur späteren LATP-Charakterisierung im MAS-NMR synthetisiert. Die Herstellung des \ce{LiTiOPO4} erfolgt analog zur Herstellung des LATP im Sol-Gel-Verfahren. Es wird jedoch auf das Aluminiumnitrat verzichtet.
\\\\
...
\chapter{Ergebnisse}
Die angefertigten Pulver werden mittels Röntgendiffraktion untersucht. Für das LATP-, LAGP- und \ce{LiTiOPO4}-Pulver werden außerdem noch Ergebnisse der Untersuchung mit der MAS-NMR-Spektroskopie vorgestellt.
\\\\
...
\toprule
 \textbf{Pulver}&\textbf{LATP} & \textbf{LAGP} & \textbf{\ce{LiTiOPO4}}& \textbf{LLTO}& \textbf{LTO}& \textbf{LiS} \\
\midrule
...
\subsection{Pulvercharakterisierung des \ce{LiTiOPO4}}
Untersucht wird das im Sol-Gel-Prozess hergestellte \ce{LiTiOPO4}. Die genaue Prozessierung über einen Sol-Gel-Prozess findet sich in Kapitel \ref{praep_LiTiOPO4}.
\subsubsection{XRD-Analyse}
...
\subsubsection{MAS-NMR-Analyse}
Versuche mit LATP-Pulver mit einem \ce{LiTiOPO4}-Fremdphasenanteil zeigten kein vom LATP-Spektrum in Abbildung \ref{mas_LATP} abweichendes Bild. Der Scan der reinen Fremdphase erzeugte einen zum LATP-Pulver äquivalenten Peak, weshalb keine Unterscheidung der beiden Pulver mittels MAS-NMR möglich war.
\newpage
\begin{figure}[b!]
	\centering
...
%   \centering
%      \subfloat[Röntgendiffraktionsspektrum]{
%	\includegraphics[width=1.0\columnwidth]{images/XRD_LiTiOPO4.png}
%	\label{xrd_LiTiOPO4}
%	} \vspace{6mm}
%      \subfloat[MAS-NMR-Spektrum]{
%	\includegraphics[width=1.0\columnwidth]{images/MAS_LATP.png}
%	\label{mas_LiTiOPO4}  
%      	} \vspace{3mm}
%	\caption{Charakterisierung des \ce{LiTiOPO4}-Pulvers mit (a)~Röntgen\-diffraktionsspektrum und (b)~MAS-NMR-Spektrum (links Übersicht über verschiedene Umdrehungsgeschwindigkeiten, rechts Nahaufnahme des Hauptpeaks bei 4kHz)}
%   	\label{pulver_LiTiOPO4}
%\end{figure}
...
\centering
      \subfloat[LATP]{
	\includegraphics[width=1.0\columnwidth]{images/REM_LATP.jpg}
	\label{edx_LATP}
	} \vspace{1mm}
      \subfloat[LAGP]{
	\includegraphics[width=1.0\columnwidth]{images/REM_LAGP.jpg}
	\label{edx_LAGP}   
      	} \vspace{1mm}
      \subfloat[LLTO]{
	\includegraphics[width=1.0\columnwidth]{images/REM_LLTO.jpg}
	\label{edx_LLTO}
	} \vspace{1mm}
      \subfloat[LTO]{
	\includegraphics[width=1.0\columnwidth]{images/REM_LTO.jpg}
	\label{edx_LTO}  
      	} \vspace{1mm}
...
Um das Gewicht des Aktivmaterials einer gestanzten Elektrodenprobe zu bestimmen, wurden jeweils fünf Proben mit einem Durchmesser von \SI{10}{\milli\metre} aus der gegossenen und getrockneten Elektrodenfolie sowie auch aus der unbehandelten Aluminiumfolie gestanzt. Diese Proben wurden anschließend abgewogen und das resultierende Gewicht gemittelt. Die Masse der unbehandelten Aluminiumfolie wurde so zu \SI{2.93}{\milli\gram} bestimmt. Aus der Differenz aus Gesamtmasse und dem Gewicht der Aluminiumfolie konnte dann die Masse des Elektrodenmaterials der Probe bestimmt werden.
\\\\
Da der Massenanteil des jeweiligen Aktivmaterials auf \SI{45}{\percent} der gesamten Elektrode eingewogen worden ist, kann dann die Masse des Aktivmaterials an einer Elektrodenprobe mittels Multiplikation mit diesem Faktor berechnet werden. Eine Übersicht über die so für alle Elektrodenproben bestimmten Massen findet sich in Tabelle \ref{tabelle_massen}.
\\
\begin{table}[h]
...
\begin{figure}[b!]
   \centering
	...
	\includegraphics[width=0.82\columnwidth]{images/CV_LATP.jpg}
	\label{cv_LATP}   
      	} \vspace{3mm}
...
\begin{figure}[b!]
   \centering
	...
	\label{gcpl_LAGP}
      ...
      \subfloat[Zyklische Voltametrie]{
	\includegraphics[width=0.80\columnwidth]{images/CV_LAGP.jpg}
	\label{cv_LAGP}   
      	} %\vspace{3mm}
      %\subfloat[Impedanzspektroskopie]{
...
\begin{figure}[b!]
   \centering
	...
	\label{gcpl_LLTO}
      ...
      \subfloat[Zyklische Voltametrie]{
	\includegraphics[width=0.82\columnwidth]{images/CV_LLTO.jpg}
	\label{cv_LLTO}   
      	} \vspace{3mm}
      %\subfloat[Impedanzspektroskopie]{
...
\begin{figure}[htb!]
   \centering
	...
	\label{gcpl_LTO}
      ...
      \subfloat[Zyklische Voltametrie]{
	\includegraphics[width=0.82\columnwidth]{images/CV_LTO.jpg}
	\label{cv_LTO}   
      	} \vspace{3mm}
      %\subfloat[Impedanzspektroskopie]{
...
\begin{figure}[b!]
   \centering
	...
	\label{gcpl_LiS}
      ...
      \subfloat[Zyklische Voltametrie]{
	\includegraphics[width=0.85\columnwidth]{images/CV_LiS.jpg}
	\label{cv_LiS}   
      	} \vspace{3mm}
...
%\\\\
%Die Batterie besitzt außerdem noch, bedingt durch den Testaufbau, Kabel, Stempel und auch dem Elektrolyten, einen inneren Widerstand. Verschaltet man diesen nun mit den zwei RQ-Gliedern für die Grenzschichten und dem Warburg-Element, so erhält man das in Abbildung \ref{schaltbild_2RQ} dargestellte Reihenmodell als elektrochemisches Ersatzschaltbild für die untersuchten Zellen. 
%\begin{figure}
%   \centering
%      \subfloat[Reihenmodell]{
%	\includegraphics[width=0.65\columnwidth]{images/Schaltbild_2RQ.png}
%	\label{schaltbild_2RQ}
%	} \vspace{10mm}
%      \subfloat[Parallelmodell]{
%	\includegraphics[width=0.65\columnwidth]{images/Schaltbild_Randles.png}
%	\label{schaltbild_Randles}      
%      	} \vspace{6mm}
%	\caption{Elektrochemisches Ersatzschaltbild des Reihen- sowie des Parallelmodells}
%   	\label{ersatzschaltbilder}
%\end{figure} 
%\subsubsection{Parallelmodell}
%Anstatt einer reinen Verkettung von RQ- und Warburg-Elementen, können diese auch teilweise parallel geschaltet werden. Das entsprechende elektrochemische Ersatzschaltbild wird in Abbildung \ref{schaltbild_Randles} dargestellt. %Erklärung? Unterschied?
%\subsection{Auswertung der Impedanzspektroskopie}
%Mit den aufgestellten Modellen wurden anschließend Fits  zu den realen Messungen mit der Software ZView angefertigt und deren Güte und Aussagekraft untersucht. Die erhaltenen Daten sind in Tabelle \ref{tabelle_is} dargestellt.
%\\
%\begin{table}[h]
...
%& Modell & Reihe & Parallel & Reihe & Parallel & Reihe & Parallel & Reihe & Parallel\\
%\midrule
...
% \end{table} 
%\\
%Der innere Widerstand der untersuchten Zellen liegt auf einem einheitlichen Niveau. Lediglich die LATP-Probe zeigt einen leicht niedrigeren Widerstand. Der Testaufbau verhält sich daher bei allen Experimenten ähnlich.
%\\\\
%Beim Vergleich der beiden Modelle fällt auf, dass besonders bei der LAGP-Probe teilweise erhebliche Unterschiede von bis zu einem Faktor 5 zwischen den Widerständen, Kapazitäten und Frequenzen herrscht. Für die restlichen Proben bleibt dieser bei maximal 1,5. Dabei erscheint besonders der Fit der Parallelschaltung von den Ergebnissen der anderen Fits abzuweichen. Grundsätzlich bewegen sich allerdings alle Zahlenwerte der erhaltenen Fits in plausiblen Größenordnungen.
%\\\\
%Ein Vergleich der gefitteten Frequenzen mit denen der DRT ist in Tabelle \ref{tabelle_vergleich_frequenzen} gegeben. Zu erkennen ist hier, dass die Frequenzen der Fits teilweise mehr als zehnmal so hoch wie von der DRT ermittelt sind. Problem ist hier die Nichtbeachtung der Frequenzen durch ZView. Durch diese fehlende Optimalitätsbedingung können die Fits nicht in Einklang mit der DRT gebracht werden. 
%\\\\
%Insgesamt lässt sich sagen, dass die Daten der Impedanzspektroskopie zum Teil sehr stark schwanken und nur in Teilen miteinander in Relation zu bringen sind. Dies erschwert eine fundierte Analyse der Daten. Auf einen Vergleich der ermittelten Grenzschichtkapazitäten wird daher verzichtet.
%\begin{table}[h]
...
%Die Ergebnisse der elektrochemischen Charakterisierung ermöglichen zwei weitere Themenschwerpunkte.
\\\\
...
%\\\\
%Zum Anderen kann man mit einer besseren Untersuchung der Impedanzspektroskopie weitere Aussagen über das System treffen. Hier wird es vor allem darauf ankommen, die elektrochemischen Ersatzschaltbilder weiter zu validieren. Besonderes Augenmerk könnte dabei auf einen Fit gelegt werden, der sowohl die Ergebnisse der DRT, als auch des Ersatzschaltbildes nutzt.
\\\\
