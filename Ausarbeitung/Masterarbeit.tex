...
\\
\begin{table}[h]
\begin{tabular}{L{2.2cm} L{3.5cm} L{3.2cm} L{2.2cm} L{2.2cm}}
\toprule
&\textbf{LATP}&\textbf{LAGP}&\textbf{LTO}&\textbf{LLTO} \\
\midrule
\textbf{SE} & \ce{Li_{1,3}Al_{0,3}Ti_{1,7}(PO4)3} & \ce{} & \ce{Li4Ti5O12} & \ce{} \\
\midrule
\textbf{Mol. Masse} & \SI{383.8}{\gram\per\mol}&& \SI{412}{\gram\per\mol}& \\
\midrule
\textbf{Kapazität} & \SI{61.3}{\milli\ampere\hour\per\gram} && \SI{186.4}{\milli\ampere\hour\per\gram}& \\
\midrule
\textbf{Kap./Mol} & \SI{23.53}{\ampere\hour\per\mol} && \SI{76.80}{\ampere\hour\per\mol}& \\
\midrule
\textbf{Li$^+$/SE} & 0,878 && 2,866 & \\
\bottomrule
\end{tabular}
