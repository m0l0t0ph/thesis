...
\usepackage[FIGTOPCAP]{subfigure} % Grafiken nebeneinander darstellen
...
\begin{figure}
\centering
\begin{subfigure}[Röntgendiffraktionsspektrum]
	{
	\centering
...
\end{subfigure}
~
\begin{subfigure}[MAS-NMR-Spektrum]
	{
	\centering
...
\caption{Charakterisierung des LATP-Pulvers mit (a)~Röntgen\-diffraktionsspektrum und (b)~MAS-NMR-Spektrum (links Übersicht über verschiedene Umdrehungsgeschwindigkeiten, rechts Nahaufnahme des Hauptpeaks bei 4kHz)}
\end{figure}
Untersucht wird das im Sol-Gel-Prozess hergestellte \ce{LiTiPO5}. Die genaue Prozessierung findet sich in Kapitel \ref{praep_LiTiPO5}.
\subsubsection{XRD-Analyse}
\subsubsection{MAS-NMR-Analyse}
...
Die Herstellung der weiteren Pulver wird in Kapitel \ref{methodik_weitere_Pulver} beschrieben. Sie erfolgt bei der LAGP-Probe über den Sol-Gel-Prozess, bei der LTO- und der LLTO-Probe über eine Misch\-oxid-Route.
\subsubsection{LAGP}
\begin{figure}
\centering
\begin{subfigure}[Röntgendiffraktionsspektrum]
...
.
\\\\
Das Spektrum der röntgendiffraktometrische Untersuchung des LAGP in Abbildung \ref{xrd_LAGP} zeigt keine Zweitphasenanteile. Das verwendete Pulver ist daher phasenrein.
\\\\
...
\\\\ % WERTE CHECKEN!
Die Impedanzmessungen fanden jeweils in einem Frequenzbereich von 1 Hz bis 1 MHz statt. Die dabei angelegte Spannung betrug 10mV. % Messpunkte, Zeit 
\newpage
\subsection{LATP-Kathode}
\begin{figure}
\centering
\begin{subfigure}[Ladekennlinie]
	{
	\centering
	\includegraphics[width=1.0\columnwidth]{images/GCPL_LATP.jpg}
	\label{gcpl_LATP}
	}
\end{subfigure}
~
\begin{subfigure}[Zyklische Voltametrie]
	{
	\centering
...
\end{subfigure}
~
\begin{subfigure}[Impedanzspektroskopie]
	{
	\centering
