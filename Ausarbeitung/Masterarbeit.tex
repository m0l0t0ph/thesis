...
\cmidrule{2-6}
 & \textit{Elektrode ohne Kollektor} &   \SI{1.24}{\milli\gram} &  \SI{1.05}{\milli\gram} &  \SI{1.12}{\milli\meter}& \SI{1.35}{\milli\gram}\\
\cmidrule{2-6}
 & \textit{Aktivmaterial} &   \SI{0.56}{\milli\gram} &   \SI{0.47}{\milli\gram} & \SI{0.50}{\milli\gram}& \SI{0.61}{\milli\gram}\\
\bottomrule
\end{tabular}
 \caption{Massen der unterschiedlichen Proben.}
 \label{tabelle_massen}
 \end{table} 
Um das Gewicht des Aktivmaterials einer gestanzten Elektrodenprobe zu bestimmen, wurden jeweils fünf Proben aus der gegossenen Folie sowie auch aus der unbehandelten Aluminiumfolie gestanzt.
