...
\end{figure}
Die Elektrochemie einer Batteriezelle basiert auf einem Potential zwischen zwei räumlich getrennten Materialien. Durch den Anschluss eines externen Stromkreises kann dieses Potential entweder unter Abgabe von Energie abgebaut oder unter Zugabe von Energie vergrößert werden (QUELLE). 
\\\\
Es existieren zwei grundsätzliche Mechanismen zur Ladungsübertragung und Speicherung (QUELLE):
...
\begin{figure}
	...
	\caption{Spannunglsagen verschiedener Elektrodenmaterialien (links) und ihre entsprechenden Kanalstrukturen (rechts) \cite{bub_skript}}
